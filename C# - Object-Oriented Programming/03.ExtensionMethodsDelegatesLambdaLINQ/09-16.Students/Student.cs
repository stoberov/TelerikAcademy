    ...
    public class Student
    {
        ...
        public string FacultyNumber
        {
            ...
            set
            {
                ...
                {
                    throw new ApplicationException("Faculty number is an 8-digit number !");
                }
        ...
        public string Telephone
        {
            ...
            set
            {
                if (string.IsNullOrEmpty(value))
                {
                    throw new ArgumentNullException("Telephone number cannot be null or empty !");
                }

                if (!Regex.IsMatch(value, @"(\+359[0-9]{9})") && !Regex.IsMatch(value, @"(0[0-9]{9})"))
                {
                    throw new ApplicationException("Telephone number must begin with +359 / 0 followed by 9 digits !");
                }
        ...
        public string Email
        {
            ...
            set
            {
                ...
                {
                    throw new ApplicationException("E-mail must be valid !");
                }
