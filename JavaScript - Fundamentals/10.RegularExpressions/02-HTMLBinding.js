...
var phraseOne = '<div data-bind-content="name"></div>';
var phraseTwo = '<a data-bind-content="name" data-bind-href="link" data-bind-class="name"></div>';
...
console.log(phraseOne.bind('', {name: 'Steven'}));
console.log(phraseTwo.bind('', {name: 'Elena', link: 'http://telerikacademy.com'}));
